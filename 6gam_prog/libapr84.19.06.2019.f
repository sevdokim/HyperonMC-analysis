...
C-   &              /0.004, 0.050,   0.004, 0.004, 0.004/               ! kondr
C-   &              /0.005, 0.050,   0.004, 0.004, 0.004/               ! kondr
     &              /0.010, 0.050,   0.004, 0.004, 0.004/               ! kondr
...
C
      if (probhyp(nhip).lt.prob(real(chiq),nf))   ! At first probhyp(nhip) = -1
...
C
  ...
  110 IF ( MBCMB2.NE.0.AND.CHIQ.GT.CHP2) GO TO 112                      
      ...
      MBCMB2 = ICOMB                                                    
C
C-    write(*,*) 'FPAR(46)=',FPAR(46),CHIQ,prob(real(chiq),nf)
 
  112 IF ( MFIT.NE.0.AND.CHIQ.GE.FPAR(46)) GO TO 498
C-112 IF ( MFIT.NE.0.AND.CHIQ.GE.FPAR(46).AND.NHIP.NE.2) GO TO 498      ! here we just skip the rest of the 
...
C: Pchi=0.30     IF (PCHI.LT.0.30) GO TO 498
C
		 IF (PCHI.LT.0.20) GO TO 498
      ENDIF
C
...
Cmike
  ...
  499 CONTINUE
      ...
      CALL HF1( 999, FLOAT(50*(NGAM-3)+10*NHIP+JFIT), 1.)
      CALL HF1(1000, FLOAT(10*NGAM+NHIP),1.)
C
...
!     hopefully, SA probability cut doesn't interfere with this
      ...
      if (khp.ne.nhyf) write(*,*)'khp,nhyf=',IEV,NGAM,NHIP,MFIT,khp,nhyf
