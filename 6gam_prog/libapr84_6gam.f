...
C
      ...
      EQUIVALENCE   (K1,MCMC6(1)),(K2,MCMC6(2)),(K3,MCMC6(3)),(K4,MCMC6(4)),
     +              (K5,MCMC6(5)),(K6,MCMC6(6)),
...
C      
      CHIR = CHIQ  
      PCHI = PROB(CHIR,NF)
      IF (probhyp(nhip).lt.PCHI) probhyp(nhip) = PCHI ! probhyp()   
...
C      
  ...
  498 CONTINUE        ! End of the combination cycle
C
      CALL HF1( 999, FLOAT(50*(NGAM-3)+10*MFIT+10+MBCOMB), 1.) ! best combination histo 
      CALL HF1(1000, FLOAT(30*(NGAM-3)+10*MFIT+10)+RKOMB,1.)   ! ?? what is difference? 
C
      IF ( MBCOMB.EQ.0) GO TO 800 
C
      LNFIT = 12                    ! magic number ! what is this ? ;k
...
C      
      ...
      if(ig.eq.6) ih=1000*ig+100*ihyp
C
