...
do
	...
	for mass in 0
	    ...
	    case "$TGT_PRFX" in 
		"be79mm")	echo "/ Distance mm: 3698; 79. 10000"  > file_list.dat	;;
		"c78mm")	echo "/ Distance mm: 3695; 78. 10268"  > file_list.dat	;;
		"al35mm")       echo "/ Distance mm: 3658; 35. 9962"  > file_list.dat	;;
		"al17mm")	echo "/	Distance mm: 3776; 17. 9711"   > file_list.dat  ;;
		"cu3mm")	echo "/ Distance mm: 3674; 3. 9821"    > file_list.dat	;;
		"cu7mm")	echo "/ Distance mm: 3672; 7. 9821"    > file_list.dat 	;;
		"sn5mm")	echo "/ Distance mm: 3673; 5. 9804"    > file_list.dat	;;
		"pb3mm")        echo "/ Distance mm: 3674; 3. 9737"    > file_list.dat  ;;
		"ch80mm")       echo "/ Distance mm: 3700; 80. 9730"   > file_list.dat	;;
