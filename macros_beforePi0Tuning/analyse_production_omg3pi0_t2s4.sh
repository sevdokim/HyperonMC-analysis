...
do
    for cond in t2 s4 #""
    do
	for MES in omgpi0gamma omg3pi0 omg2pi0 omgetapi0 #rho0 # eta omg pi0 K0 f2Mike omg 2pi0
        do
	    ...
	    if /bin/ls ${PRODUCTION_NAME}/MCruns/*.gz -1  > /tmp/hyp_runs_$nmesons ; then
