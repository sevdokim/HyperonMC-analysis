...
do
	...
	for mass in {700..1900..50}
	    ...
	    case "$TGT_PRFX" in 
		"be79mm")	echo "/ Distance mm: 3698; 79. 9964"  > file_list.dat	;;
		"c78mm")	echo "/ Distance mm: 3695; 78. 10233"  > file_list.dat	;;
		"al35mm")       echo "/ Distance mm: 3658; 35. 9910"  > file_list.dat	;;
		"al17mm")	echo "/	Distance mm: 3776; 17. 9726"   > file_list.dat  ;;
		"cu3mm")	echo "/ Distance mm: 3674; 3. 9746"    > file_list.dat	;;
		"cu7mm")	echo "/ Distance mm: 3672; 7. 9746"    > file_list.dat 	;;
		"sn5mm")	echo "/ Distance mm: 3673; 5. 9730"    > file_list.dat	;;
		"pb3mm")        echo "/ Distance mm: 3674; 3. 9542"    > file_list.dat  ;;
		"ch80mm")       echo "/ Distance mm: 3700; 80. 9936"   > file_list.dat	;;
