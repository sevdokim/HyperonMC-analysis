...
do
	...
	for mass in 0
	    ...
	    COMBINED_NAME=${PRODUCTION_NAME}_dist+0.5percent
	    ...
	    case "$TGT_PRFX" in 
		"be79mm")	echo "/ Distance mm: 3718; 79. 10050"  > file_list.dat	;;
		"c78mm")	echo "/ Distance mm: 3715; 78. 10316"  > file_list.dat	;;
		"al35mm")   echo "/ Distance mm: 3678; 35. 10012"  > file_list.dat	;;
		"al17mm")	echo "/	Distance mm: 3796; 17. 9726"   > file_list.dat  ;;
		"cu3mm")	echo "/ Distance mm: 3694; 3. 9872"    > file_list.dat	;;
		"cu7mm")	echo "/ Distance mm: 3692; 7. 9872"    > file_list.dat 	;;
		"sn5mm")	echo "/ Distance mm: 3693; 5. 9855"    > file_list.dat	;;
		"pb3mm")    echo "/ Distance mm: 3694; 3. 9788"    > file_list.dat  ;;
		"ch80mm")   echo "/ Distance mm: 3720; 80. 9781"   > file_list.dat	;;
